...
summary(res_1)
#white and indian are significant
...
summary(res_5) #the other programs are not significant, even though CB020 is close to 5% level
anova(res_2, res_5, test="Chisq") #p=0.09198
...
summary(res_6) #interaction term not significant (p=0.1377)
anova(res_2,res_6, test="Chisq") #p=0.2459
...
anova(res_2,res_7, test="Chisq") #p=0.6351
