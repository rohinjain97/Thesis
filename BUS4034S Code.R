...
BUS4034S_data=read.csv("BUS4034S.xlsx", header = TRUE, sep = ";" )

#need to remove the NA observations
BUS4034S_data<-na.omit(BUS4034S_data)
attach(BUS4034S_data)

ID = BUS4034S_data[2]
exam_set = cbind(BUS4034S_data[1],BUS4034S_data[2], BUS4034S_data[4])
...
exam_set2 = cbind(BUS4034S_data[1],BUS4034S_data[2], BUS4034S_data[4],BUS4034S_data[5] ,BUS4034S_data[7], BUS4034S_data[11], BUS4034S_data[12], BUS4034S_data[14])
...
var.test(male_marks_non_protests, male_marks_protests, alternative = "two.sided")

t.test(male_marks_non_protests, male_marks_protests, alternative = "two.sided", var.equal = TRUE)
...
exemption_set = cbind(BUS4034S_data[1],BUS4034S_data[2], BUS4034S_data[5])
